...
// Consultar la información de la tabla `actc`
$query = "SELECT descripcion, lugar, fecha FROM actc";
...
<body>
    <div class="container py-5">
        <h1 class="heading text-center mb-5">Actividades Curriculares</h1>
        <div class="row g-4">
