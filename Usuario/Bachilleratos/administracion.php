...
$query_bachillerato = "SELECT * FROM bachilleratos WHERE nombre = 'Administracion de Negocios'";
...
if ($stmt_coordinadores->rowCount() === 0) {
    echo "No se encontraron coordinadores para el bachillerato de Administracion de Negocios.<br>";
}
...
if ($stmt_cursos->rowCount() === 0) {
    echo "No se encontraron cursos para el bachillerato de Administracion de Negocios.<br>";
}
?>
...
<head>
    ...
    <title>Administración - Bachillerato</title>
...
<body>
    <div class="container py-5">
        ...
        <h1>
            <i class="fas fa-briefcase"></i> <!-- Icono de maletín para Negocios -->
    ...
    <!-- Plan de Estudios Administración -->
<section class="estudio">
    <div class="container">
        <h1 class="glowing-text text-center mb-5">Plan de Estudios Administración</h1>
