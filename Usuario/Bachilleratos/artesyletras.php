...
$query_bachillerato = "SELECT * FROM bachilleratos WHERE nombre = 'Artes y Letras'";
...
if ($stmt_coordinadores->rowCount() === 0) {
    echo "No se encontraron coordinadores para el bachillerato de Artes y Letras.<br>";
}
...
if ($stmt_cursos->rowCount() === 0) {
    echo "No se encontraron cursos para el bachillerato de Artes y Letras.<br>";
}
?>
...
<head>
    ...
    <title>Artes y Letras - Bachillerato</title>
...
<body>
    <div class="container py-5">
        ...
        <h1>
            <i class="fas fa-feather-alt"></i> <!-- Icono de pluma para Letras -->
        ...
        <h2 class="glowing-text">Coordinadora</h2>
            <?php foreach ($coordinadores as $coordinador): ?>
                <div class="col-md-4 coordinator-card mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="../img/aryl.jpg" alt="Coordinador" />
    ...
    <section class="estudio">
        <div class="container">
            <h1 class="glowing-text text-center mb-5">Plan de Estudios Artes y Letras</h1>
