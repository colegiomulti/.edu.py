...
$query_bachillerato = "SELECT * FROM bachilleratos WHERE nombre = 'Contabilidad'";
...
if ($stmt_coordinadores->rowCount() === 0) {
    echo "No se encontraron coordinadores para el bachillerato de Contabilidad.<br>";
}
...
if ($stmt_cursos->rowCount() === 0) {
    echo "No se encontraron cursos para el bachillerato de Contabilidad.<br>";
}
?>
...
<head>
    ...
    <title>Contabilidad - Bachillerato</title>
...
<body>
    <div class="container py-5">
        ...
        <h1>
            <i class="fas fa-coins"></i> <!-- Icono de monedas para Contabilidad -->
    ...
    <section class="estudio">
        <div class="container">
            <h2 class="glowing-text text-center mb-5">Plan de Estudios Contabilidad</h2>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#planEstudiosAccordion">
                        <div class="accordion-body">
                            ...
                            <li>Contabilidad y Legis. Aplicada</li>
                               ...
                               <li>Orientación</li>
                               <li>Calculo Merc. y Financiero</li>
