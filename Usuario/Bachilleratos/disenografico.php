...
$query_bachillerato = "SELECT * FROM bachilleratos WHERE nombre = 'Diseno Gráfico y Publicidad'";
...
if ($stmt_coordinadores->rowCount() === 0) {
    echo "No se encontraron coordinadores para el bachillerato de Diseño grafico.<br>";
}
...
if ($stmt_cursos->rowCount() === 0) {
    echo "No se encontraron cursos para el bachillerato de  Diseño Grafico.<br>";
}
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Bachillerato Técnico en Diseño Gráfico y Publicidad</title>
    <!-- Link de Bootstrap 5 -->
...
<div class="container py-5">
        ...
        <h1>
            <i class="fas fa-palette"></i> <!-- Icono de paleta para Diseño Gráfico -->
        ...
        <h2 class="glowing-text">Coordinadora</h2>
            ...
            <?php foreach ($coordinadores as $coordinador): ?>
                <div class="col-md-4 coordinator-card mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="../img/contabilidad.jpg" alt="Coordinador" />
    ...
    <section class="estudio py-5">
        <div class="container">
            <h1 class="glowing-text text-center mb-5">Plan de Estudios Diseño Gráfico y Publicidad</h1>
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#planEstudiosAccordion">
                        <div class="accordion-body">
                            <ul class="list-unstyled">
                                <li>Taller de Diseño</li>
                                <li>Gráfica Computarizada</li>
                                <li>Ilustración</li>
                                <li>Fotografía</li>
                                <li>Matemática</li>
                                <li>Castellano</li>
