...
$query_bachillerato = "SELECT * FROM bachilleratos WHERE nombre = 'Electricidad'";
...
if ($stmt_coordinadores->rowCount() === 0) {
    echo "No se encontraron coordinadores para el bachillerato de Electricidad.<br>";
}
...
if ($stmt_cursos->rowCount() === 0) {
    echo "No se encontraron cursos para el bachillerato de Electricidad.<br>";
}
?>
...
<head>
    ...
    <title>Electricidad - Bachillerato</title>
...
<body>
    <div class="container py-5">
        ...
        <h1>
            <i class="fas fa-lightbulb"></i> <!-- Icono de bombillo para Electricidad -->
    ...
    <section class="estudio">
        <div class="container">
            <h2 class="glowing-text text-center mb-5">Plan de Estudios Electricidad</h2>
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#planEstudiosAccordion">
                        <div class="accordion-body">
                            ...
                            <li>Orientación Educacional y Sociolaboral</li>
                                ...
                                <li>Antropología Cultural y Sociolaboral</li>
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#planEstudiosAccordion">
                        <div class="accordion-body">
                            ...
                            <li>Electrónica</li>
                              ...
                              <li>Educación Física</li>
                              <li>Matemática</li>
                              <li>Tutoría de Proyecto</li>
                              <li>Cirncias Naturales</li>
                              <li>Orientación</li>
                              <li>Historia y Geografia</li>
