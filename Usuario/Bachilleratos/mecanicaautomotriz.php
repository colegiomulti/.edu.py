...
$query_bachillerato = "SELECT * FROM bachilleratos WHERE nombre = 'Mecanica Automotriz';";
...
if ($stmt_coordinadores->rowCount() === 0) {
    echo "No se encontraron coordinadores para el bachillerato de Mecanica Automotriz.<br>";
}
...
if ($stmt_cursos->rowCount() === 0) {
    echo "No se encontraron cursos para el bachillerato de Mecanica Automotriz.<br>";
}
?>
...
<head>
    ...
    <title>Mecánica Automotriz</title>
    <!-- Link de Bootstrap 5 -->
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Mecánica Automotriz - Bachillerato</title>
...
<div class="container py-5">
        ...
        <h1>
        <i class="fas fa-car"></i> <!-- Icono de coche -->
        ...
        <h2 class="glowing-text">Coordinador</h2>
    
            <?php foreach ($coordinadores as $coordinador): ?>
                <div class="col-md-4 coordinator-card mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="../img/auto_salud.jpg" alt="Coordinador" />
   ...
   <!-- Plan de Estudios Automotriz -->
<section class="estudio">
    <div class="container">
        <h1 class="glowing-text text-center mb-5">Plan de Estudios Automotriz</h1>
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#planEstudiosAccordion">
                    <div class="accordion-body">
                        <ul class="list-unstyled">
                            ...
                            <li>Seguimiento e Higiene</li>
                            <li>Matemática</li>
                            <li>Tecnología Automotriz</li>
                            <li>Química</li>
                            <li>Taller Automotriz</li>
                            <li>Física</li>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#planEstudiosAccordion">
                    <div class="accordion-body">
                        <ul class="list-unstyled">
                            <li>Taller Automotriz</li>
                            <li>Orientación Educacional</li>
                            <li>Economía y Gestión</li>
                            <li>Laboratorio Diesel</li>
                            <li>Electricidad y Electrónica</li>
                            <li>Psicología</li>
                            <li>Matemática</li>
                            <li>Lengua Castellana</li>
                            <li>Ciencias Naturales</li>
                            <li>Tecnología Automotriz</li>
                            <li>Plan Optativo: Tecnología</li>
                            <li>Educación Física</li>
                            <li>Mecánica Aplicada</li>
                            <li>Historia y Geografía</li>
                        </ul>
