...
$query_bachillerato = "SELECT * FROM bachilleratos WHERE nombre = 'Mecánica General'";
...
if ($stmt_coordinadores->rowCount() === 0) {
    echo "No se encontraron coordinadores para el bachillerato de Mecánica General.<br>";
}
...
if ($stmt_cursos->rowCount() === 0) {
    echo "No se encontraron cursos para el bachillerato de Mecánica General.<br>";
}
?>
...
<head>
    ...
    <title>Mecanica General - Bachillerato</title>
...
<body>
        ...
        <div class="row justify-content-center mb-5">
            ...
            <?php foreach ($coordinadores as $coordinador): ?>
                <div class="col-md-4 coordinator-card mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="../img/electricidad.jpg" alt="Coordinador" />
   ...
   <!-- Plan de Estudios Mecánica General -->
<section class="estudio">
    <div class="container">
        <h1 class="glowing-text text-center mb-5">Plan de Estudios Mecánica General</h1>
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#planEstudiosAccordion">
                    <div class="accordion-body">
                        <ul class="list-unstyled">
                            ...
                            <li>Lengua y Literatura Castellana</li>
                            <li>Química</li>
                            <li>Guaraní</li>
                            <li>Física</li>
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#planEstudiosAccordion">
                    <div class="accordion-body">
                        <ul class="list-unstyled">
                            ...
                            <li>Física</li>
                            <li>Taller de seguridad e Higiene</li>
                            <li>Tecnología Mecánica</li>
                            <li>Educación Física</li>
                            <li>Laboratorio de Mecánica</li>
                            <li>Guaraní</li>
