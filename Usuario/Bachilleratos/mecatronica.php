...
$query_bachillerato = "SELECT * FROM bachilleratos WHERE nombre = 'Mecatrónica'";
...
if ($stmt_coordinadores->rowCount() === 0) {
    echo "No se encontraron coordinadores para el bachillerato de Mectrónica.<br>";
}
...
if ($stmt_cursos->rowCount() === 0) {
    echo "No se encontraron cursos para el bachillerato de Mecatrónica.<br>";
}
?>
...
<head>
    ...
    <title>Mectrónica - Bachillerato</title>
...
<body>
    <div class="container py-5">
        ...
        <h1>
            <i class="fas fa-robot"></i> <!-- Icono de robot -->
        ...
        <div class="row justify-content-center mb-5">
            ...
            <?php foreach ($coordinadores as $coordinador): ?>
                <div class="col-md-4 coordinator-card mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="../img/meca.jpg" alt="Coordinador" />
    ...
    <section class="estudio">
        <div class="container">
            <h1 class="glowing-text text-center mb-5">Plan de Estudios Mecatrónica</h1>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#planEstudiosAccordion">
                        <div class="accordion-body">
                            ...
                            <li>Tecnología Mec.</li>
                               <li>Física</li>
                               <li>Diseño Industrial</li>
                               <li>Química</li>
                               <li>Taller de Mecatrónica</li>
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#planEstudiosAccordion">
                        <div class="accordion-body">
                            ...
                            <li>Matemática</li>
                                ...
                                <li>Química</li>
                                <li>Física</li>
                                <li>Laboratorio de Mecatrónica</li>
                                <li>Lengua Castellana</li>
                                <li>Educación Física</li>
                                <li>Informática</li>
                                <li>Taller de Mecatrónica</li>
