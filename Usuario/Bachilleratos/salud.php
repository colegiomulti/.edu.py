...
$query_bachillerato = "SELECT * FROM bachilleratos WHERE nombre = 'Salud';";
...
if ($stmt_coordinadores->rowCount() === 0) {
    echo "No se encontraron coordinadores para el bachillerato de Salud.<br>";
}
...
if ($stmt_cursos->rowCount() === 0) {
    echo "No se encontraron cursos para el bachillerato Salud.<br>";
}
?>
...
<head>
    ...
    <title>Salud  - Bachillerato</title>
...
<div class="container py-5">
    ...
    <h1>
        <i class="fas fa-notes-medical"></i> <!-- Icono de cruz médica de Font Awesome -->
   ...
   <!-- Plan de Estudios Salud -->
<section class="estudio">
    <div class="container">
        <h1 class=" glowing-text text-center mb-5">Plan de Estudios Salud</h1>
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#planEstudiosAccordion">
                    <div class="accordion-body">
                        <ul class="list-unstyled">
                            <li>Física</li>
                            <li>Farmacología</li>
                            <li>Salud Pública y Comunicación</li>
                            <li>Guaraní Ñe'e</li>
                            <li>Química</li>
                            <li>Anatomía</li>
                            <li>Ciencias Naturales</li>
                            <li>Práctica Comunitaria</li>
                            <li>C.R.A</li>
                            <li>Educación Física</li>
                            <li>Educación para la Salud</li>
                            <li>Formación Ética y Ciudadana</li>
                            <li>Historia y Geografía</li>
                            <li>Sociología y Antropología</li>
                            <li>Atención Básica de Salud</li>
