...
$query_bachillerato = "SELECT * FROM bachilleratos WHERE nombre = 'Ciencias Sociales'";
...
if ($stmt_coordinadores->rowCount() === 0) {
    echo "No se encontraron coordinadores para el bachillerato de Ciencias Sociales.<br>";
}
...
if ($stmt_cursos->rowCount() === 0) {
    echo "No se encontraron cursos para el bachillerato de Ciencias Sociales.<br>";
}
?>
...
<head>
    ...
    <title>Ciencias Sociales - Bachillerato</title>
...
<body>
    <div class="container py-5">
        ...
        <h1>
            <i class="fas fa-users"></i> <!-- Icono de grupo de personas -->
        ...
        <h2 class="glowing-text">Coordinadora</h2>
            <?php foreach ($coordinadores as $coordinador): ?>
                <div class="col-md-4 coordinator-card mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="../img/sociales.jpg" alt="Coordinador" />
    ...
    <section class="estudio">
        <div class="container">
            <h1 class="glowing-text text-center mb-5">Plan de Estudios Ciencias Sociales</h1>
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#planEstudiosAccordion">
                        <div class="accordion-body">
                            ...
                            <li>Lengua Castellana</li>
                                ...
                                <li>Sociología</li>
                                <li>Lengua Extranjera</li>
                                <li>Educación Económica y Financiera</li>
