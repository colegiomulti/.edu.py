...
if (isset($id)) {
    $sql = $conexion->query("SELECT * FROM acte WHERE id = $id");
    if ($sql->num_rows > 0) {
...
<head>
    ...
    <title>Modificar actividades extracurriculares</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
</head>
<body class="bg-info-subtle">
   
    <h1 class="text-center p-3 bg-info-sutil text-info-emphasis">Modificar Datos de las Actividades Extracurriculares</h1>
    <form class="col-4 p-3 m-auto " method="POST" action="../controlador/modificar_acte.php"> <!-- Asegúrate de que el action es correcto -->
