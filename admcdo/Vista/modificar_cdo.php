...
if (isset($id)) {
    $sql = $conexion->query("SELECT * FROM cdo WHERE id = $id");
    if ($sql->num_rows > 0) {
...
<body class="bg-info-subtle">
    ...
    <h1 class="text-center p-3 bg-info-sutil text-info-emphasis">Modificar Datos del Cuerpo Docente</h1>
    <form class="col-4 p-3 m-auto " method="POST" action="../controlador/modificar_cdo.php"> <!-- Asegúrate de que el action es correcto -->
