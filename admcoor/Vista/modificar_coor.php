...
if (!empty($id)) {
    $id = $conexion->real_escape_string($id); // Escapar el ID para mayor seguridad
    $sql = $conexion->query("SELECT * FROM coordinadores WHERE id = $id");
...
<body class="bg-info-subtle">
    <h1 class="text-center p-3 bg-info-sutil text-info-emphasis">Modificar Coordinador</h1>
    <form class="col-4 p-3 m-auto" method="POST" action="../controlador/modificar_coor.php">
